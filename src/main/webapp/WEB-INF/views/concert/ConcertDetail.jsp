...
<html lang="UTF-8">
<link rel="stylesheet"
	href="${path}/resources/css/concert_detail.css.css">
<head>
<meta charset="UTF-8">
	...
	<div class="wrap">
		...
		<section class="concertdetail">
			<article id="title_article">
				...
				<div id="title">
					<div id="first_title">
						<a href="#"> <!-- 콘서트>페스티벌--> ${all.con_detail_subject}

						</a>
					</div>
					<div id="second_title">
						<p1>${all.con_detail_name}</p1>
					</div>
					<div id="third_title">
						<div id="date">${all.con_detail_period}&nbsp; | &nbsp;</div>
						<div id="place">
							<a href="#"> ${all.con_detail_place} <img
								src="${path}/resources/img/detail/common/ico-big-location.png"
								alt="">
							</a>
						</div>
					</div>
					<div id="social_btn">
						<a href="#"> <img
							src="${path}/resources/img/detail/common/rn-social.png" alt="소셜">
						</a>
					</div>
				</div>
			...
			<article id="poster_article">
				<div id="poster">
					<div id="poster_space">
						<img
							src="${path}/resources/img/detail/${main.con_detail_title}/${main.con_detail_imagelist_name}"
							alt="">
					</div>
					<div id="likes">
						<ul>
							<li><a href="#"> <img
									src="${path}/resources/img/detail/common/rn-product-good2.png"
									alt="하트">
							</a></li>
							<li><a href href="#"> 숫자 </a></li>
					...
					<div id="grade_info">
						...
						<div id="grade_time">
							<ul>
								...
								<li id="time_li"><c:choose>
										<c:when
											test="${all.con_detail_time==null || all.con_detail_time==''}">
                            --
                            </c:when>
										<c:otherwise>
                             ${all.con_detail_time}
						...
						<div id="grade_cast">
							<ul>
								...
								<li id="cast_li"><c:choose>
										<c:when
											test="${all.con_detail_cast==null || all.con_detail_cast==''}">
                            &nbsp; &nbsp; &nbsp; &nbsp;--
                            </c:when>
										<c:otherwise>
                            ${all.con_detail_cast }
						...
						<div id="grade_price">
							<ul>
								<li class="text_bold">가격</li>

								<div id="price_div">
									<li>2일권 <span>158,000</span>원
									</li>
									<li>1일권 <span>99,000</span>원
									</li>
								</div>
							</ul>
						</div>
						<div id="grade_advantages">
							<ul>
								...
								<li id="advantages_li"><a href="#"> 사용가능쿠폰
										<div class="background_img1">
											<div class="bar">|</div>
										</div>
								</a></li>
								<li id="advantages_li"><a href="#"> 무이자할부
										<div class="background_img1">
											<div class="bar">|</div>
										</div>
								</a></li>
								<li id="advantages_li"><a href="#"> 제휴카드할인
			...
			<article id="booking_article">
				<div id="booking">
					<c:choose>
						...
						<c:otherwise>
							<a
								href="${path}/reservation/date.do?detail_id=${all.con_detail_id}&genre=${genre}">
								<div id="booking_1">예매하기</div>
							</a>
						</c:otherwise>
					</c:choose>
			...
			<article id="banner_article">
				<div id="banner">
					<a href="#"> <img
						src="${path}/resources/img/detail/common/banner2.jpg" alt="">
					</a>
				</div>
				<div class="clear"></div>
			</article>
			...
			<article id="notice_article">
				<div id="notice">
					<span id="notice_subject">유의사항</span> <br> <span
						id="notice_contents"> 매수 제한: 1인 4매까지<br> 티켓 발급 안내: 관람일
						전일 20시에 YES24공연 APP을 통해 예매자 아이디로 모바일 티켓(바코드) 발급<br> 주의 사항:
						예매자 아이디로 발급된 모바일 티켓 지참 시에만 입장 가능 <br> 모바일 티켓 캡처본 및 사본 절대 불가 <br>
						<br> * 예매 완료 후에는 티켓 종류(1일권의 날짜 포함), 예매자 명의 변경이 불가합니다. <br>
						* 예매 시 티켓 권종(2일권/일자별 1일권)을 확인하시기 바랍니다. <br> <br> <br>

						<span id="notice_contents_red"> ※ 티켓 예매에 앞서 티켓 예매처의 취소, 환불
							조항은 물론 상세 사항을 반드시 확인해주시기 바랍니다. <br> ※ 티켓 예매를 하는 것은 주최 측과 티켓
							예매처의 안내와 규정을 확인하였으며 이에 동의함을 의미합니다. <br> ※ 자세한 예매 및 티켓 수령, 입장
							관련 사항은 아래 상세 내용을 확인하시기 바랍니다. <br>
					</span>
					</span>
				</div>
			</article>
				...
				<div id="info_pics">
					...
					<c:forEach var="infoimages" items="${info}" varStatus="info_pics">
						<div id="info_pics${info_pics.count}">
							<img
								src="${path}/resources/img/detail/${infoimages.con_detail_title }/${infoimages.con_detail_imagelist_name}"
								alt="">
						</div>
					</c:forEach>
				</div>
			...
			<article id="detail_info_article">
				<div id="detail_info">
					<span id="detail_info_text"> 상품정보제공 고시 </span>
						...
						<div id="table_fourth_line">
							...
							<div id="fourth_line_right">
								<div id="fourth_line_text1">
									취소 일자에 따라 아래와 같이 취소수수료가 부과됩니다. 예매일보다 관람일 기준이 우선 적용되오니 유의해주시기
									바랍니다. <br> 단, 예매 후 7일 이내라도 취소시점이 공연일로부터 10일 이내라면 그에 해당하는
									취소수수료가 부과됩니다. <br> (단, 상품에 따라 취소 정책이 달라질 수 있고, 각 공연이 공지하는
									취소 정책이 우선 적용되므로, 예매 시 참고하시기 바랍니다.) <br>
								</div>
								<div id="fourth_line_table">
									...
									<div class="fourth_line_table3">
										<ul>
											...
											<li><span id="table3_red"> 장당 4,000원</span>(단, 티켓 금액의
												10% 이내)</li>
										</ul>
									</div>
								...
								<div id="fourth_line_text2">
									...
									티켓이 배송된 후에는 PC/모바일 취소가 불가, 취소마감시간 이전에 예스24 고객센터로 티켓이 반송되어야 취소
									가능합니다. <br> (취소수수료는 티켓 도착일 기준으로 부과되며, 배송비는 환불되지 않습니다.) <br>
